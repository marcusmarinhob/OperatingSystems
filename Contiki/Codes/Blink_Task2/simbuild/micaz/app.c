...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x403912a8, const void *arg_0x40391440);
#line 780
__extension__ 
#line 797
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x40535840), 
int (*key_eq_fn)(void *arg_0x40535c88, void *arg_0x40535e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x4066b9b8, int arg_0x4066bb10);
static inline double RandomUniform(void );
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408c3178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408c3178, msg, payload, len);
#line 78
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408c5ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408c5ac8, msg, payload, len);
#line 78
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408c5108, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x408c5108, msg, error);
#line 110
}
#line 110
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40707630){
#line 75
  switch (arg_0x40707630) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40707630);
#line 75
      break;
#line 75
    }
...
static inline void BlinkC$Timer3$fired(void )
{
  sim_log_debug(151U, "BlinkC", "I am Timer 3 and I have the shortest period!. Fired @ %s.\n", sim_time_string());
}
