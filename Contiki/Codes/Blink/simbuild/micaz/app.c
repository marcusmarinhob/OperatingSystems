...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x4039f2a8, const void *arg_0x4039f440);
#line 780
__extension__ 
#line 797
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x40543840), 
int (*key_eq_fn)(void *arg_0x40543c88, void *arg_0x40543e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x406799b8, int arg_0x40679b10);
static inline double RandomUniform(void );
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408d1178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408d1178, msg, payload, len);
#line 78
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408d3ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408d3ac8, msg, payload, len);
#line 78
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408d3108, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x408d3108, msg, error);
#line 110
}
#line 110
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40715630){
#line 75
  switch (arg_0x40715630) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40715630);
#line 75
      break;
#line 75
    }
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b6dc70){
#line 83
  switch (arg_0x40b6dc70) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b6dc70);
#line 83
      break;
#line 83
    }
